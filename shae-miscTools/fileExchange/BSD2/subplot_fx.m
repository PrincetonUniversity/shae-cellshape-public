function theAxis = subplot(nrows, ncols, thisPlot, varargin)%SUBPLOT Create axes in tiled positions.
...
% BPB notes, this version was included from the file exchange with
% "spaceplots.m". 

warning('subplot:oldVersion',...
    'This version of subplot was packaged with spaceplots. Considering using the matlab builtin');
