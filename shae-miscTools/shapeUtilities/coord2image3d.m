function Image=coord2image3d(varargin)
...
Zpts=(0:1/upFactor:stack)+1/upFactor/2;
        ...
        %deal with histcn occasionally wanting to make things slightly
        %bigger for some reason....
if all(size(Image)==(imsize+1))
    Image=Image(1:end-1,1:end-1,1:end-1);
end
